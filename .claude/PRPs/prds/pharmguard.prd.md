...
| 7 | Frontend dashboard surfaces | Add adherence-log live feed, alert panel, slot-status grid in `frontend/src/app/` | pending | with 6 | 1 | - |
| 8 | Offline queue + reliability | SQLite buffer for adherence logs; reconnect/replay logic; chaos test | pending | - | 6 | - |
| 9 | Accuracy validation | Run 1,000-pill labelled bench; record confusion matrix; document residual gap to 99% target | pending | - | 6 | - |
